...
do CUDA_VISIBLE_DEVICES=${gpu_id} DISPLAY="" python simpler_env/main_inference.py --policy-model ${policy_model} --ckpt-path ${ckpt_path} \
  ...
  --additional-env-save-tags octo_init_rng_${init_rng} --host ${HOST} --port ${PORT} \
