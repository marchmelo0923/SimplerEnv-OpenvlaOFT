...
if __name__ == "__main__":
    ...
    elif args.policy_model == "oft":
        assert args.ckpt_path is not None
        from simpler_env.policies.oft.oft_model import OFTInference
        host = args.host
        port = args.port
        server_endpoint = f"http://{host}:{port}/act"
        print(f"[Client]: *** server_endpoint: {server_endpoint} ***")
        model = OFTInference(
